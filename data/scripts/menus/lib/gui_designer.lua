...
function gui_designer:create(width, height)
  ...
  -- Makes a frame of the specified size with a green border.
  function widget:make_yellow_frame(x, y, width, height)
    draw_frame_8_8(24, 24, canvas, x, y, width, height)
  end

  -- Makes a frame of the specified size with a green border.
  function widget:make_red_frame(x, y, width, height)
    draw_frame_8_8(48, 24, canvas, x, y, width, height)
  end
